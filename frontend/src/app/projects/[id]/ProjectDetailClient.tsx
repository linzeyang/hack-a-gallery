    ...
    <div className="min-h-screen bg-gray-50 py-8 sm:py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-4 sm:mb-6">
          <Link href="/events" className="text-blue-600 hover:text-blue-800 flex items-center gap-2 text-sm sm:text-base">
        ...
        <Card className="mb-4 sm:mb-6">
          <CardHeader className="p-4 sm:p-6">
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Project Links</h2>
          </CardHeader>
          <CardBody className="p-4 sm:p-6">
            <div className="space-y-3">
              {/* GitHub URL */}
              <div className="flex items-start gap-3">
                <svg className="w-5 h-5 sm:w-6 sm:h-6 text-gray-700 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-xs sm:text-sm text-gray-500">GitHub Repository</p>
                  <a
              ...
              {project.demoUrl && (
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-gray-700 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                  </svg>
                  <div className="min-w-0 flex-1">
                    <p className="text-xs sm:text-sm text-gray-500">Live Demo</p>
                    <a
        ...
        {project.technologies.length > 0 && (
          <Card className="mb-4 sm:mb-6">
            <CardHeader className="p-4 sm:p-6">
              <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Technologies Used</h2>
            </CardHeader>
            <CardBody className="p-4 sm:p-6">
            ...
            <CardBody className="p-4 sm:p-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                {project.teamMembers.map((member, index) => (
                  <div key={index} className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg min-h-[72px]">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-semibold text-sm sm:text-base text-gray-900 truncate">{member.name}</p>

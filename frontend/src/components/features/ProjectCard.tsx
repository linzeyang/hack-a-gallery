          ...
          <div className="border-t border-gray-200 pt-3">
            ...
            <div className="flex flex-wrap gap-2">
              {project.teamMembers.slice(0, 3).map((member, index) => (
                ...
                >
                  <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center text-white text-xs font-semibold flex-shrink-0">
